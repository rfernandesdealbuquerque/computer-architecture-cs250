...
#define OPCODE_NOR    0x3
#define OPCODE_NAND   0x4
#define OPCODE_SLL    0x5
#define OPCODE_SRL    0x6
#define OPCODE_LW     0x7
#define OPCODE_SW     0x8
#define OPCODE_BEQ    0x9
#define OPCODE_BGE    0xA
#define OPCODE_J      0xB
...
instruction_t opcode_arr[] = {
    ...
    instruction_t(OPCODE_NOR,   "nor",    R),
    ...
    instruction_t(OPCODE_BGE,   "bge",    IBranchComp),
